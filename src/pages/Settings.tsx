    ...
    <div className="flex flex-col h-full bg-[#0a0a0a] overflow-y-auto no-scrollbar relative min-h-screen">
      ...
      <div className="px-4 py-2 space-y-1">
        <button 
          ...
          className="w-full flex items-center justify-between py-5 hover:bg-neutral-800/20 transition group"
        >
        ...
        <button onClick={() => navigate("/user-contract")} className="w-full flex items-center justify-between py-5 hover:bg-neutral-800/20 transition group">
          <span className="text-[15px] font-medium text-gray-200">{t("userContract")}</span>
          <ChevronRight className="w-4 h-4 text-neutral-500" />
        </button>

        <button onClick={() => navigate("/privacy-policy")} className="w-full flex items-center justify-between py-5 hover:bg-neutral-800/20 transition group">
          <span className="text-[15px] font-medium text-gray-200">{t("privacyPolicy")}</span>
          <ChevronRight className="w-4 h-4 text-neutral-500" />
        </button>

        <button onClick={() => navigate("/sobre")} className="w-full flex items-center justify-between py-5 hover:bg-neutral-800/20 transition group">
          <span className="text-[15px] font-medium text-gray-200">Sobre</span>
          <ChevronRight className="w-4 h-4 text-neutral-500" />
        </button>

        <button onClick={() => navigate("/contato")} className="w-full flex items-center justify-between py-5 hover:bg-neutral-800/20 transition group">
          <span className="text-[15px] font-medium text-gray-200">Contato</span>
          <ChevronRight className="w-4 h-4 text-neutral-500" />
        </button>

        <button className="w-full flex items-center justify-between py-5 hover:bg-neutral-800/20 transition group">
          <span className="text-[15px] font-medium text-gray-200">{t("notifications")}</span>
          <ChevronRight className="w-4 h-4 text-neutral-500" />
        </button>

        <button onClick={() => navigate("/account-management")} className="w-full flex items-center justify-between py-5 hover:bg-neutral-800/20 transition group">
        ...
        <div className="w-full flex items-center justify-between py-5">
          ...
          <button 
            ...
            className={`font-medium px-6 py-2 rounded-xl text-[14px] transition ${cacheSize !== "0 MB" ? "bg-red-600 text-white hover:bg-red-700 active:bg-red-800" : "bg-[#1c1c1e] text-neutral-500 disabled:opacity-50"}`}
          >
            {t("clear")}
          </button>
        </div>
